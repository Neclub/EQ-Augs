...
from eq_augs.aug_stats import clean_stats, legacy_from_stats, merge_stats
from eq_augs.eqresource_augs import USER_AGENT, resolve_eqresource_augs
...
from eq_augs.raidloot import AugCandidate, CatalogResult
